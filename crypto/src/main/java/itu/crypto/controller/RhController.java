...
import itu.crypto.model.Contract;
//importation of the model

//Service 
import itu.crypto.service.*;
//importation of the repository 
import itu.crypto.repository.ContractRepository;
import itu.crypto.repository.EmployeRepository;
import itu.crypto.repository.TerminationTypeRepository;
import itu.crypto.repository.TerminationRepository;
