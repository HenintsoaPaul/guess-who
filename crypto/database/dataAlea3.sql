...
-- Insertion de données dans la table 'commission'
INSERT INTO commission (name, val) VALUES
    ('Commission sur Achat', 0.50),
    ('Commission sur Vente', 0.25),
    ('Commission de Référencement', 0.75);

-- Insertion de données dans la table 'type_mv_wallet'
INSERT INTO type_mv_wallet (name) VALUES
    ('Dépôt'),
    ('Retrait'),
    ('Achat'),
    ('Vente'),
...
INSERT INTO type_mv_fund (name) VALUES
    ('Dépôt'),
    ('Retrait'),
    ('Référencement');
...
INSERT INTO wallet (quantity, id_crypto, id_account) VALUES
    (100, 1, 1),
    (150, 1, 2),
    (200, 1, 3),
    (120, 2, 1);
...
-- Alice
INSERT INTO mv_wallet (date_mv, quantity, id_wallet, id_type_mv_wallet) VALUES
    ('2025-01-08 10:00:00', 100, 1, 1),
...
INSERT INTO sale (date_sale, id_account) VALUES
    ('2025-01-08 13:00:00', 1),
    ('2025-01-09 14:30:00', 2),
    ('2025-01-10 15:30:00', 3);

-- Insertion de données dans la table 'sale_detail'
INSERT INTO sale_detail (quantity, quantity_left, id_crypto, id_sale) VALUES
    (1000, 800, 1, 1),
    (1500, 1200, 2, 2),
    (2000, 1800, 3, 3);

-- Insertion de données dans la table 'purchase'
INSERT INTO purchase (date_purchase, quantity, id_account, id_sale_detail) VALUES
    ('2025-01-09 11:30:00', 500, 1, 1),
